...
const get = <T = any>(url: string = '', params: object = {}, options: AxiosRequestConfig = {}): Promise<T> => {
  // return request.get(请求地址,{   headers:{},timeout:6000, params:{}   })
  return request.get(url, { ...options, params });
};

const del = <T = any>(url: string = '', params: object = {}, options: AxiosRequestConfig = {}): Promise<T> => {
  // return request.get(请求地址,{   headers:{},timeout:6000, params:{}   })
  return request.delete(url, { ...options, params });
};

const post = <T = any>(url: string = '', data: object = {}, options: AxiosRequestConfig = {}): Promise<T> => {
  //   return request.post(请求地址, data, { headers: {}, timeout: 6000 })
  return request.post(url, data, options);
};

const put = <T = any>(url: string = '', data: object = {}, options: AxiosRequestConfig = {}): Promise<T> => {
  //   return request.post(请求地址, data, { headers: {}, timeout: 6000 })
